...
variable "RESOURCE_GROUP" {
  default = "func-rg-dedicated-linux-container"
}
variable "LOCATION" {
  default = "JapanEast"
}
...
resource "azurerm_function_app" "example" {
  ...
  site_config {
    ...
    linux_fx_version = "DOCKER|ghcr.io/levi106/functiontestterraform220513:0.1"
  }
}
...
resource "azurerm_function_app_slot" "example-slot" {
  ...
  site_config {
    ...
    linux_fx_version = "DOCKER|ghcr.io/levi106/functiontestterraform220513:0.2"
  }
}